                                    ...
                                    IdeRunner      *runner)
{
  ...
  dzl_signal_group_set_target (self->client_signals, self->client);
...
gbp_gdb_debugger_init (GbpGdbDebugger *self)
{
  ...
  self->client_signals = dzl_signal_group_new (MI2_TYPE_CLIENT);

  dzl_signal_group_connect_object (self->client_signals,
                                   "breakpoint-inserted",
